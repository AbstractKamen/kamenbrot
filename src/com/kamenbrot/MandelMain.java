...
public class MandelMain {
    ...
    public static final int PRECISION_SWITCH_ZOOM_LEVEL = 32;
    ...
    public static void main(String[] args) {
        ...
        frame.addKeyListener(new MandelKeyListener(panel.getPanelState(), panel, miniPanel, paletteState));
        ...
        final MouseAdapter mouseAdapter = new MouseAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                final GenericMandelState<?> mandelState = (GenericMandelState<?>) panel.getMandelState();
                final Double re = ComplexMapping.mapComplex(e.getX(), mandelState.getMandelWidth(), mandelState.getMinX().doubleValue(), mandelState.getMaxX().doubleValue());
                final Double imag = ComplexMapping.mapComplex(e.getY(), mandelState.getMandelHeight(), mandelState.getMinY().doubleValue(), mandelState.getMaxY().doubleValue());
            ...
            public void mouseWheelMoved(MouseWheelEvent e) {
                ...
                if (state instanceof MandelDoubleState cast && state.getCurrentZoom() > PRECISION_SWITCH_ZOOM_LEVEL) {
                    ...
                    panel.setMandelState(newMandelState);
                    panel.setImageGenerator(new MandelbrotBlockImageGenerator(panel.getImageGenerator(), newMandelState, panel.getPanelState(), panel.getColorState()));
